...
const Profile = () => {
  return (
    ...
    <h1 className='text-center font-bold text-xl mb-5 text-4xl'>Profile</h1>
    <div className="box flex flex-col justify-center items-center ">
        ...
        <button className=' text-white bg-blue-600 w-full p-1 my-2 text-center  rounded-md shadow-md my-3'>Update Profile</button>
